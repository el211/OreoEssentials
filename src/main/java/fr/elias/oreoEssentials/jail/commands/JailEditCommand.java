package fr.elias.oreoEssentials.jail.commands;

import fr.elias.oreoEssentials.jail.JailModels;
import fr.elias.oreoEssentials.jail.JailService;
...
public final class JailEditCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] a) {
        ...
        switch (a[0].toLowerCase(Locale.ROOT)) {
            ...
            case "addcell" -> {
                if (a.length < 3) { sender.sendMessage("§c/jailedit addcell <jailName> <cellId>"); break; }
