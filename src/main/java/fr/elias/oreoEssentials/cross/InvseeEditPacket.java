// File: src/main/java/fr/elias/oreoEssentials/cross/InvseeEditPacket.java
...
/**
 * Viewer node -> owner node: "set slot X in target's inventory to this item".
 */
public final class InvseeEditPacket extends Packet {

    private UUID targetId;
    private UUID viewerId;
    private int slot;            // 0..35
    private byte[] itemBytes;    // encoded single ItemStack
